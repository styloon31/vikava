...
const About_Section4 = ({ progress, range, targetScale }) => {
    ...
    >
      <div className="bg-[#666]/30 @apply  flex flex-col relative h-screen w-full transform-origin-top">
        ...
        >
            <Image
            alt=""
            src={'/services/a3.jpeg'}
            width={500} height={500}
            className="hidden lg:block lg:w-[35%] h-full object-cover"></Image>
            <div className="flex flex-col w-full h-full justify-center items-center ">
                <div className="  w-full h-auto lg:relative -left-[10%]">
                    <h2 className={`${barlow.className} text-white text-3xl sm:text-7xl`}>Why now?</h2>
                </div>
