...
const Section13 = ({ progress, range, targetScale }) => {
            ...
            <div className=" w-full lg:w-full h-full relative flex items-start justify-center flex-col">
              <div className="absolute shadow-lg -right-1 lg:w-[28%] h-[60%] bg-white top-[10%] bottom-[10%] pl-10">
                <div className="flex flex-col items-start justify-center text-left w-full h-full">
                  ...
                  >
                    For whom Vikara labs is?
                  </h1>
                  <p className={` text-[14px] font-normal  text-left`}>
                    Be it a brand, startup, designer label, export
                    <br />
                    house,manufacturer, supplier, or even an
                    <br /> value addition partner across any sector
                    <br /> viz. Apparels, home furnishings and
                    <br /> accessories, vikava labs targets entire
                    <br /> Indian fashion industry..
                  </p>
              ...
              <div
                ...
                className="bg-[url('/backgrounds/13.jpg')] w-full lg:w-[90%] h-full "
              ></div>
            </div>
          </div>
        </motion.section>
