...
const Section5 = ({ progress, range, targetScale }) => {
            ...
            <div className=" w-full lg:w-full h-full relative flex items-start justify-center flex-col">
              <div className="absolute shadow-lg -right-1 lg:w-[28%] h-[60%] bg-white top-[10%] bottom-[10%] pl-10">
                <div className="flex flex-col items-start justify-center text-left w-full h-full">
                  ...
                  >
                    We have seen, how industry had been <br /> working since the
                    begining. What worked
                    <br /> earlier, won&apos;t be able to deliver results
                    <br /> today. To tackle tough present & future
                    <br /> challanges, vikava labs is being incepted.
                  </p>
              ...
              <div
                ...
                className="bg-[url('/backgrounds/5.jpg')] w-full lg:w-[90%] h-full "
              ></div>
            </div>
          </div>
        </motion.section>
